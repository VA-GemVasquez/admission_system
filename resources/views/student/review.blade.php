        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    <p class="text-yellow-300 text-sm">Application #{{ str_pad($application->id, 5, '0', STR_PAD_LEFT) }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="mb-6 flex items-center text-sm">
                ...
                <a href="{{ route('student.apply') }}" class="text-gray-500 hover:text-blue-900 transition">Application Form</a>
                <svg class="w-4 h-4 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                </svg>
                <span class="text-blue-900 font-semibold">Review Application</span>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-yellow-400">
                ...
                <div class="psu-gold-bg px-8 py-4">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-blue-900">Application Review</h2>
                                <p class="text-blue-800 text-sm">Please review your information carefully</p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3">
                            <span class="text-sm font-medium text-blue-900">Status:</span>
                ...
                <div class="p-8 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-yellow-50">
                    <div class="flex items-center">
                        ...
                        <div class="ml-6">
                            <h3 class="text-2xl font-bold text-blue-900">{{ $application->firstname }} {{ $application->middlename }} {{ $application->lastname }}</h3>
                            ...
                            <div class="info-card">
                                ...
                                <div class="mt-4 p-3 bg-yellow-50 rounded-lg">
                                    <p class="text-sm text-yellow-800 flex items-center">
                                        ...
                                        Your application is pending review. You will be notified once a decision is made.
                                    </p>
                                </div>
                                @elseif($application->status == 'Approved')
            ...
            <div class="mt-6 bg-blue-50 border-l-4 border-blue-900 p-4 rounded-r-lg">
                <div class="flex">
                    ...
                    <div>
                        <h4 class="font-bold text-blue-900 mb-1">Important Reminder</h4>
