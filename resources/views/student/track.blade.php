    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-6 flex items-center text-sm bg-white p-3 rounded-lg shadow-sm">
                ...
                <a href="{{ route('student.apply') }}" class="text-gray-500 hover:text-blue-900 transition flex items-center">
                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-yellow-400 track-card">
                <div class="psu-gold-bg px-8 py-6">
                    ...
                    <p class="text-blue-800 mt-2 ml-11">Enter your credentials below to check your admission status</p>
                </div>
                ...
                <div class="p-8">
                    ...
                    <div class="bg-blue-50 rounded-lg p-4 mb-6 flex items-start">
                        <svg class="w-5 h-5 text-blue-900 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                        </svg>
                        <p class="text-sm text-blue-800">Enter either your Application ID or the Gmail address you used to apply. Your information is secure and encrypted.</p>
                    </div>
                    ...
                    <form action="{{ route('student.lookup') }}" method="GET" class="space-y-6" id="trackForm" onsubmit="return validateForm()">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 pt-4">
                            <a href="{{ route('student.apply') }}" class="text-gray-500 hover:text-blue-900 transition flex items-center order-2 sm:order-1">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                                </svg>
                                Back to Application Form
                            </a>
                            <button type="submit" class="psu-blue-bg text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-blue-800 transition transform hover:scale-105 shadow-lg flex items-center order-1 sm:order-2">
            ...
            <div class="mt-6 text-center">
                <p class="text-xs text-gray-500">
                    ...
                    <a href="#" class="text-blue-900 hover:underline">Privacy Policy</a> and 
