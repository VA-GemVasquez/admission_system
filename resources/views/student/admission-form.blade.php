...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-5xl mx-auto">
            <!-- Track Your Application Banner - NEW FEATURE -->
            <div class="mb-6 track-card">
                <div class="flex items-center justify-between flex-wrap gap-4">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-blue-900">Already Submitted an Application?</h3>
                    ...
                    <div class="flex space-x-3">
                        <a href="{{ route('student.track') }}" 
                           class="px-6 py-3 bg-blue-900 text-white rounded-lg font-semibold hover:bg-blue-800 transition transform hover:scale-105 flex items-center">
                        ...
                        <a href="{{ route('student.lookup') }}" 
                           class="px-6 py-3 bg-yellow-500 text-blue-900 rounded-lg font-semibold hover:bg-yellow-400 transition transform hover:scale-105 flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <div class="w-10 h-10 bg-blue-900 rounded-full flex items-center justify-center text-white font-bold">1</div>
                        <div class="ml-3">
                            <p class="text-sm text-gray-500">Step 1</p>
                            <p class="font-semibold text-blue-900">Personal Info</p>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="psu-gold-bg px-8 py-4">
                    <div class="flex items-center justify-between">
                        <h2 class="text-2xl font-bold text-blue-900">Application Form</h2>
                        <div class="bg-blue-900 text-yellow-400 px-4 py-2 rounded-lg">
                ...
                <div class="p-8">
                    <form action="{{ route('student.submit') }}" method="POST" id="admissionForm">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid md:grid-cols-3 gap-6 mt-4">
                                <div>
                                    ...
                                    <input type="number" name="years_old" value="{{ old('years_old') }}" required min="15" max="100"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 transition">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">
                        ...
                        <div class="flex justify-between items-center pt-4 border-t">
                            <div class="flex space-x-3">
                                <a href="{{ route('home') }}" class="text-gray-500 hover:text-blue-900 transition flex items-center">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                                    </svg>
                                    Back to Home
                                </a>
                                <a href="{{ route('student.track') }}" class="text-blue-900 hover:text-yellow-600 transition flex items-center">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    Track Application
                            ...
                            <button type="submit"
                                    class="psu-blue-bg text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-blue-800 transition transform hover:scale-105 shadow-lg flex items-center">
                                Submit Application
            ...
            <div class="mt-8 grid md:grid-cols-2 gap-6">
                <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-yellow-400">
                    ...
                    <form action="{{ route('student.lookup') }}" method="GET" class="space-y-3">
                        ...
                        <button type="submit" 
                                class="w-full bg-blue-900 text-white px-4 py-2 rounded-lg hover:bg-blue-800 transition flex items-center justify-center">
            ...
            <div class="mt-6 bg-blue-50 border-l-4 border-blue-900 p-4 rounded-r-lg">
                <div class="flex">
                    ...
                    <div>
                        <h4 class="font-bold text-blue-900 mb-1">Important Reminders:</h4>
