    ...
    <div class="max-w-md w-full relative z-10">
        ...
        <div class="text-center mb-6">
            <div class="flex items-center justify-center space-x-3 mb-4">
                <div class="w-16 h-16 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-xl flex items-center justify-center shadow-lg">
                    <span class="text-3xl font-bold text-blue-900">PSU</span>
                </div>
            </div>
            ...
            <div class="p-8">
                <form method="POST" action="{{ route('admin.login') }}">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="#" class="text-sm text-blue-900 hover:text-yellow-600 transition">
                            Forgot Password?
                        </a>
                    </div>
                    
                    <button type="submit"
                            class="w-full psu-blue-bg text-white px-6 py-4 rounded-xl font-bold text-lg hover:bg-blue-800 transition transform hover:scale-105 shadow-lg flex items-center justify-center">
                ...
                <div class="mt-8 pt-6 border-t border-gray-200">
                    <div class="text-center">
                        <a href="{{ route('home') }}" class="text-sm text-gray-600 hover:text-blue-900 transition flex items-center justify-center">
